...
- Prevent a memory spike and cache corruption when several searches run at once (e.g. fast typing on first open): database opens are serialized, the data rebuild is de-duplicated, and the cache is written atomically
